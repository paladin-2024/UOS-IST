                ...
                <div class="card-body p-4">
                    <div class="text-center mb-3">
                        <?php if (!empty($dossier['photo'])): ?>
                            <img src="https://inbtpkinshasa.info/uploads/<?= sanitize($dossier['photo']) ?>" class="rounded-circle" width="72" height="72" style="object-fit:cover;border:3px solid var(--blue-pale);">
                        <?php else: ?>
