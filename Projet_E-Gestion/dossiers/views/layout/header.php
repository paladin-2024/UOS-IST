...
<head>
    ...
    <?php if (!empty($univLogo)): ?>
        <!-- Favicons --> 
	<link href="../<?= sanitize($univLogo) ?>" rel="icon">
	<link href="../<?= sanitize($univLogo) ?>" rel="apple-touch-icon">
    <?php endif; ?>
    ...
    <div class="sidebar-brand">
        <?php if (!empty($univLogo)): ?>
            <div class="text-center mb-2">
                <img src="../<?= sanitize($univLogo) ?>" alt="Logo" style="max-height:40px;max-width:100%;object-fit:contain;">
            </div>
        <?php endif; ?>
    ...
    <div class="sidebar-user">
        <div class="d-flex align-items-center gap-2 mb-1">
            <?php if (!empty($userPhoto)): ?>
                <img src="../uploads/<?= sanitize($userPhoto) ?>" alt="" style="width:32px;height:32px;border-radius:50%;object-fit:cover;border:2px solid rgba(255,255,255,0.2);flex-shrink:0;">
            <?php else: ?>
    ...
    <header class="topbar">
        ...
        <div class="topbar-right">
            <div class="d-flex align-items-center gap-2">
                ...
                <?php if (!empty($userPhoto)): ?>
                    <img src="../uploads/<?= sanitize($userPhoto) ?>" alt="" style="width:32px;height:32px;border-radius:50%;object-fit:cover;border:2px solid var(--gray-200);">
                <?php else: ?>
