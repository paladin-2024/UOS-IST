...
$etatDeBesoins = $structure->getEtatDeBesoinsByUser($userId, $searchQuery, 50); // Retrieve états de besoin with search and limit
    ...
    <section class="section dashboard">
        <div class="row">
            <div class="col-lg-12 mb-3">
                <button type="button" class="btn btn-primary mb-3" data-bs-toggle="modal" data-bs-target="#addEtatDeBesoinModal">
                    <i class="bi bi-plus"></i> Nouvel État de Besoin
                </button>
                <form method="GET" action="" class="mb-3">
                    <div class="input-group">
                        <input type="hidden" name="view" value="logistique/etat_besoin.add">
...
<script>
    ...
    document.getElementById('searchInput').addEventListener('keydown', function(event) {
        if (event.key === 'Enter') {
            window.location.href = 'logistique/etat_besoin.add?search=' + encodeURIComponent(this.value.trim());
        }
    });
