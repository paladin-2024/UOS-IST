                        ...
                        <form method="GET" action="">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <select class="form-select" id="section" name="section" onchange="loadPromotionsBySection(this.value)">
...
<script>
    // Fonction pour charger les promotions par section
    function loadPromotionsBySection(sectionId) {
        ...
        promotionSelect.innerHTML = '<option value=""><i class="spinner-border spinner-border-sm me-1" role="status"></i>Chargement...</option>';
