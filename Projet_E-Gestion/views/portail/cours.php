...
$stats = [
    ...
    'total_enseignants' => count(array_unique(array_column($cours, 'nom_auteur'))),
    'total_consultations' => array_sum(array_column($cours, 'nb_consultations')),
    'total_orientations' => count(array_unique(array_column($cours, 'orientation_id')))
];
    ...
    <div class="bg-primary text-white py-4 mb-4">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-md-8">
                    <h1 class="h2 mb-2">Cours</h1>
                    <p class="lead mb-0">Supports de cours et matériels pédagogiques</p>
                </div>
                <div class="col-md-4">
                    <div class="row text-center g-2">
                        <div class="col-6">
                            <div class="border rounded p-3">
                                <div class="h3 mb-0"><?= number_format($stats['total_cours']) ?></div>
                                <small>Cours</small>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="border rounded p-3">
                                <div class="h3 mb-0"><?= number_format($stats['total_enseignants']) ?></div>
            ...
            <div class="card-body">
                <form method="GET" action="" class="row g-3">
                    <div class="col-md-4">
                        ...
                        <input type="text" name="search" class="form-control" placeholder="Titre, enseignant, mots-clés..." value="<?= htmlspecialchars($search) ?>">
                    </div>
                    <div class="col-md-3">
                        ...
                        <div class="card h-100 shadow-sm">
                            ...
                            <div class="card-body">
                                ...
                                <h5 class="card-title mb-3">
                                    <a href="voir_travail?id=<?= $course['id'] ?>" class="text-decoration-none text-dark">
                                ...
                                <div class="d-flex align-items-center mb-2">
                                    ...
                                    <span>
                                        <?= htmlspecialchars($course['nom_auteur']) ?>
                                    </span>
                                </div>

                                <!-- Spécialisation -->
                                <?php if (!empty($course['specialisation'])): ?>
                                <div class="d-flex align-items-center mb-2">
                                    <i class="fas fa-graduation-cap text-muted me-2"></i>
                                    <span class="small">
                                        <?= htmlspecialchars($course['specialisation']) ?>
                                    </span>
                                </div>
                                <?php endif; ?>
                                ...
                                <div class="small text-muted mb-3">
                                    ...
                                    <?= htmlspecialchars($course['designationOrientation']) ?>
                                    <br>
                                ...
                                <p class="card-text small">
                                    <?= htmlspecialchars(substr($course['resume'], 0, 100)) ?>...
                                </p>

                                <!-- Mots-clés -->
                                <?php if (!empty($course['mots_cles'])): ?>
                                <div class="mt-2">
                                    <?php foreach (explode(',', $course['mots_cles']) as $motCle): ?>
                            ...
                            <div class="card-footer bg-white d-flex justify-content-between align-items-center">
                                <a href="voir_travail?id=<?= $course['id'] ?>" class="btn btn-sm btn-outline-primary">
                                    <i class="fas fa-eye me-1"></i> Consulter
                                </a>
                                <div class="text-muted small">
                                    <i class="fas fa-chart-bar me-1"></i>
                                    <?= number_format($course['nb_consultations']) ?> vues
                                </div>
                            </div>
                        </div>
                    </div>
