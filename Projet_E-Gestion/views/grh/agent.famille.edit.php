            ...
            <div class="modal-body">
                <form id="editFamilyMemberForm" action="controller/update_membre.php" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" id="editTypeLiaison" name="typeLiaison" required>
                            <option value="Père">Père</option>
                            <option value="Mère">Mère</option>
                            <option value="Mari">Mari</option>
                            <option value="Femme">Femme</option>
                    ...
                    <button type="submit" name="action" value="edit" class="btn btn-primary"><i class="bi bi-save"></i> Enregistrer</button>
                </form>
            </div>
        </div>
    </div>
