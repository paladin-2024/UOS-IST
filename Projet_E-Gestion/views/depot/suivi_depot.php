...
$anneeId = isset($_GET['annee']) ? $_GET['annee'] : $universite->getCurrentAcademicYear()['idannee_acad'];
$departementId = isset($_GET['departement']) ? $_GET['departement'] : '';
...
<main id="main" class="main">
    <div class="pagetitle">
        <h1>SUIVI DES DÉPÔTS</h1>
        <nav>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="#">Accueil</a></li>
                <li class="breadcrumb-item active">Suivi des Dépôts</li>
            </ol>
        </nav>
    </div>
