...
if ($promotionId) {
    try {
        ...
        // Get fees already required for fiche validation
        $query = "SELECT frais_id FROM frais_fiche_validation WHERE promotion_idpromotion = :promotionId";
        $stmt = $connexion->prepare($query);
        $stmt->execute(['promotionId' => $promotionId]);
        $ficheRequiredFeeIds = $stmt->fetchAll(PDO::FETCH_COLUMN);
    } catch (Exception $e) {
...
<main id="main" class="main">
    ...
    <div class="pagetitle">
    <h1>CONFIGURATION DES FRAIS POUR LES FICHES DE VALIDATION</h1>
    <nav>
    <ol class="breadcrumb">
    <li class="breadcrumb-item"><a href="deliberation/grilles_anciennes">Délibération</a></li>
    <li class="breadcrumb-item active">Configuration Frais Fiche Validation<?php echo $promotion ? ' - ' . htmlspecialchars($promotion['designationPromotion']) : ''; ?></li>
    </ol>
    </nav>
    </div>
    ...
    <div class="card-header">
        <h5 class="card-title">Sélectionner une Promotion</h5>
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <h5 class="card-title">Configuration des Frais pour Fiche de Validation - <?php echo htmlspecialchars($promotion['designationPromotion']); ?></h5>
                    </div>
                    <div class="card-body">
                        <div class="alert alert-info">
                            <i class="bi bi-info-circle me-2"></i>
                            <strong>Instructions:</strong> Sélectionnez les frais qui doivent être payés par les étudiants avant de pouvoir générer leur fiche de validation de crédits.
                        </div>
                    <form method="POST" action="controller/configure_fiche_validation_fees.php">
                    ...
                    <tr>
                        ...
                        <th>Montant</th>
                        <th>Devise</th>
                        <th>Requis pour Fiche de Validation</th>
                        </tr>
                        </thead>
                    <tbody>
                    ...
                    <tr>
                        ...
                        <div class="form-check">
                            <input 
                                ...
                                id="fiche_fee_<?php echo $fee['id']; ?>"
                                <?php echo in_array($fee['id'], $ficheRequiredFeeIds) ? 'checked' : ''; ?>>
                            <label class="form-check-label" for="fiche_fee_<?php echo $fee['id']; ?>"></label>
                        </div>
                        </td>
                    </tr>
                    <?php endforeach; else: ?>
                    ...
                    <div class="mt-4">
                        ...
                        <a href="deliberation/grilles_anciennes" class="btn btn-secondary btn-lg ms-2">
            ...
            <div class="col-lg-12">
                <div class="alert alert-warning">
                    ...
                    Sélectionnez une promotion pour configurer les frais requis pour la fiche de validation de crédits.
                </div>
            </div>
            <?php endif; ?>
                    </div>
