                ...
                <div class="card-footer bg-transparent">
                    <div class="d-grid gap-1">
                        <div class="btn-group btn-group-sm" role="group">
                            ...
                            <button type="button" class="btn btn-outline-success" 
                                    onclick="genererFichesValidationImport(${importItem.id})">
...
<div class="modal fade" id="modalEditionGrille" tabindex="-1" aria-labelledby="modalEditionLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modalEditionLabel">
                    <i class="bi bi-pencil-square me-2"></i>
                    Éditer la Grille
                </h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body" id="modalEditionContent">
                <!-- Contenu dynamique -->
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Annuler</button>
                <button type="button" class="btn btn-primary" onclick="sauvegarderEditionGrille()">
