...
<main id="main" class="main">
    ...
    <div class="pagetitle">
        <h1>Historique des Factures Clients</h1>
        <nav>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="#">Accueil</a></li>
                <li class="breadcrumb-item active">Factures Clients</li>
            </ol>
        </nav>
    </div><!-- End Page Title -->
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card overflow-auto">
                    <div class="card-body">
                        <h5 class="card-title">Recherche des Factures Clients</h5>

                        <!-- Search Form -->
                        <form method="GET" action="" class="mb-3">
                            <div class="input-group">
                                <input type="hidden" name="view" value="comptabilite/facture_cl.historique">
                        ...
                        <table class="table table-striped table-bordered" id="invoiceTable">
                            ...
                            <tbody>
                                ...
                                foreach ($structures as $structure) {
                                    ...
                                    if ($ver1->fetch()) {
                                $invoices = $structureModel->getInvoicesByUserAccess2($userId,$structure['idStructure'], $searchName, $startDate, $endDate);
