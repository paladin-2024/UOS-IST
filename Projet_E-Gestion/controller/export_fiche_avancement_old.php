...
.ministere {
    ...
    foreach ($sujetsEtudiant as $sujet) {
        ...
        $role = ($sujet['idDirecteur'] == $_SESSION['id']) ? 'Directeur' : 'Encadreur';
        ...
        <table class="info-table">
            ...
            <tr>
                <th>Directeur</th>
                <td>' . htmlspecialchars($sujet['directeur']) . '</td>
            </tr>
            <tr>
                <th>Encadreur</th>
                <td>' . htmlspecialchars($sujet['encadreur']) . '</td>
            </tr>
            <tr>
        ...
        foreach ($taches as $tache) {
            ...
            // Dans la boucle des échanges, remplacer cette partie :
            if (!empty($echanges)) {
