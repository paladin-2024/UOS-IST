                        ...
                        <div class="card overflow-auto">
                            <div class="card-body">
                                ...
                                <form id="filtersForm" method="GET" action="" class="mb-3">
                                    <input type="hidden" name="view" value="configuration/journal_serveur">
                                ...
                                <div class="row mb-3">
                                    <div class="col-12">
                                        <a href="configuration/journal_connexions" class="btn btn-primary btn-sm">
                                            <i class="bi bi-box-arrow-in-right"></i> Journal Connexions
                                        </a>
                                        <a href="configuration/journal_statistiques" class="btn btn-info btn-sm">
                                            <i class="bi bi-bar-chart"></i> Statistiques
                                        </a>
                                        <a href="controller/export_journal_excel.php?<?= http_build_query($_GET) ?>" class="btn btn-success btn-sm">
                                            <i class="bi bi-download"></i> Exporter Excel
                                        </a>
                                        <a href="configuration/journal_nettoyer" class="btn btn-warning btn-sm">
                                        ...
                                        <?php if (!empty($resultats['logs'])): ?>
                                            <?php $i = 1; foreach ($resultats['logs'] as $log): ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="?view=configuration/journal_details&id=<?= $log['id_log'] ?>" 
                                ...
                                <?php if (isset($resultats['pages']) && $resultats['pages'] > 1): ?>
                                    <nav aria-label="Pagination">
                                        <ul class="pagination justify-content-center">
                                            <?php 
                                            $queryString = http_build_query(array_merge($_GET, ['view' => 'configuration/journal_serveur']));
