...
if ($bureauId) {
    if ($isAdmin) {
        ...
        // Filtrer les promotions par sections dont l'agent est responsable
        $promotions = $deliberation->getPromotionsByJuryAndSections($bureauId, $sectionsResponsable);
    }
}
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form method="GET" action="" class="row g-3 mb-4">
                            <input type="hidden" name="view" value="deliberation/documents_etudiants">
                            ...
                            <?php if ($bureauId && $promotionId && ($semestreId || $afficherDeuxSemestres) && $sessionId && $anneeId): ?>
                                <div class="col-12 text-center">
                                    ...
                                    <a href="?view=deliberation/documents_etudiants" class="btn btn-secondary">
