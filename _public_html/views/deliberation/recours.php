...
$query_annee_encours = "SELECT idannee_acad, designation FROM annee_acad WHERE est_active = 1 LIMIT 1";
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="row align-items-center mb-4">
                    <div class="col-md-6">
                        <form method="GET" action="deliberation/recours" id="form-selection-etudiant">
