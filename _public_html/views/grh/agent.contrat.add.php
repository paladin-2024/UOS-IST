        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card overflow-auto">
                                ...
                                if ($ver1->fetch()) {
                                    ...
                                    echo "
                                        <tr>
                                            ...
                                            <td>
                                                <button type='button' class='btn btn-primary btn-sm add-contract-btn' data-agent-id='{$agent['idAgent']}' data-structure-id='{$agent['idStructure']}' data-bs-toggle='modal' data-bs-target='#addContractModal'>
                                        ...
                                        echo "
                                            <tr class='{$contractStatusClass}'>
                                                ...
                                                <td>
                                                    ...
                                                    <form action='controller/delete_contrat.php' method='POST' class='delete-contract-form' style='display:inline;'>
                                                        <input type='hidden' name='idContratAgent' value='{$contract['idContrat_agent']}'>
                                                        <button type='button' class='btn btn-danger btn-sm delete-contract-btn'>Supprimer</button>
                                                    </form>
                                                </td>
                                            </tr>
                                        ";
                    ...
                    <div class="modal fade" id="addContractModal" tabindex="-1" aria-labelledby="addContractModalLabel" aria-hidden="true" data-bs-backdrop="static">
    <div class="modal-dialog modal-dialog-centered modal-lg"> <!-- Increased size of the modal -->
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="addContractForm" action="controller/create_contrat.php" method="POST">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="number" step="0.01" class="form-control" id="salaireDeBase" name="salaireDeBase" required>
                        </div>
                    </div>
                    <div class="mb-3">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="editContractForm" action="controller/update_contrat.php" method="POST">
                    ...
                    <button type="submit" name="action" value="add" class="btn btn-primary"><i class="bi bi-save"></i> Enregistrer</button>
                </form>
            </div>
        </div>
    </div>
