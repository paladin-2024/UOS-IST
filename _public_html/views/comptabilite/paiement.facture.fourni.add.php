        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card overflow-auto">
                    <div class="card-body">
                        <h5 class="card-title">Paiements des Factures Fournisseurs</h5>

                        <!-- Search Form -->
                        <form method="GET" action="" class="mb-3">
                            <div class="input-group">
                                <input type="hidden" name="view" value="comptabilite/paiement.facture.fourni.add">
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="addPaymentForm" action="controller/add_payment_fournisseur.php" method="POST">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <select class="form-control" id="paymentBank" name="bankId" required>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                <label for="paymentBeneficiaire" class="form-label">Bénéficiaire <span class="text-danger">*</span></label>
                                <input type="text" class="form-control" id="paymentBeneficiaire" name="beneficiaire" required>
                            </div>
                            <div class="col-md-6">
                                <label for="paymentMode" class="form-label">Mode de Paiement <span class="text-danger">*</span></label>
                                <input type="text" class="form-control" id="paymentMode" name="modePaiement" required>
                            </div>
                        </div>
