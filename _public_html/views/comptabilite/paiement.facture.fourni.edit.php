                                            ...
                                            foreach ($payments as $payment) {
                                                echo "
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <button type='button' class='btn btn-danger btn-sm cancel-payment-btn' data-payment-id='{$payment['idPaiement_fournisseur']}'>Annuler</button>
                                    ...
                                    button.addEventListener('click', function () {
                                        ...
                                        Swal.fire({
                                            ...
                                            if (result.isConfirmed) {
                                                window.location.href = 'controller/cancel_payment_fournisseur.php?idPaiement=' + paymentId;
                                            }
                                        });
                                    });
                                });
