...
<main id="main" class="main">
    ...
    <div class="pagetitle">
        <h1>Générer le Journal Comptable</h1>
        <nav>
            <ol class="breadcrumb">
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card overflow-auto">
                    <div class="card-body">
                        <h5 class="card-title">Génération du Journal Comptable</h5>

                        <!-- Form to generate accounting journal Excel file -->
                        <form id="generateJournalForm" action="controller/generate_journal_excel.php" method="POST">
                            <div class="row mb-3">
                                <div class="col-md-6">
                            ...
                            <button type="submit" class="btn btn-primary">
                                <i class="bi bi-file-earmark-excel"></i> Générer le Fichier Excel
                            </button>
                        </form>
