...
function dselect(el, option = {}) {
  ...
  const searchInput = search ? `<input onkeydown="return event.key !== 'Enter'" onkeyup="dselectSearch(event, this, '${classElement}', '${classToggler}', ${creatable})" type="text" class="form-control" placeholder="Recherchez ici..." autofocus>` : "";
