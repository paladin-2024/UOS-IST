...
<head>
    ...
    <?php if (!empty($loginUnivLogo)): ?>
        <!-- Favicons --> 
	<link href="../<?= sanitize($loginUnivLogo) ?>" rel="icon">
	<link href="../<?= sanitize($loginUnivLogo) ?>" rel="apple-touch-icon">
    <?php endif; ?>
...
<div class="mobile-hero">
    <div class="mobile-hero-content">
        <div class="mobile-hero-logo">
            <?php if (!empty($loginUnivLogo)): ?>
                <img src="../<?= sanitize($loginUnivLogo) ?>" alt="Logo">
            <?php else: ?>
    ...
    <div class="left-content">
        ...
        <?php if (!empty($loginUnivLogo)): ?>
            <div style="margin-bottom:16px;">
                <img src="../<?= sanitize($loginUnivLogo) ?>" alt="Logo" style="max-height:100px;">
            </div>
        <?php endif; ?>
